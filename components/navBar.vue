...
<template>
  <nav class="bg-slate-100 top-0 sticky z-20">
    <div
      class="flex flex-row items-center h-16 border-b border-solid border-b-red-500"
    >
      <div
        class="w-1/3 flex flex-1 flex-row justify-start md:justify-center items-center"
      >
